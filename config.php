...
if (!defined('ESEWA_MERCHANT_ID')) define('ESEWA_MERCHANT_ID', 'JB0BBQ4aD0UqIThFJwAKBgAXEUkEGQUBBAwdOgABHD4DChwUAB0R'); // Test merchant

// eSewa endpoints - Test Environment (v2 API)
// Documentation URL: https://developer.esewa.com.np/#/epay
if (!defined('ESEWA_URL')) define('ESEWA_URL', 'https://rc-epay.esewa.com.np/api/epay/main/v2/form');
if (!defined('ESEWA_VERIFY_URL')) define('ESEWA_VERIFY_URL', 'https://rc-epay.esewa.com.np/api/epay/transaction/status');
if (!defined('ESEWA_SECRET_KEY')) define('ESEWA_SECRET_KEY', '8gBm/:&EnhH.1/q'); // Test environment secret key
